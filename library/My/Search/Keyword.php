...
class Keyword extends SearchAbstract {
    ...
    public function createIndex() {
        ...
        $mapping->setProperties([
            ...
            'key_name' => ['type' => 'string', 'store' => 'yes', 'index_analyzer' => 'translation_index_analyzer', 'search_analyzer' => 'translation_search_analyzer', 'term_vector' => 'with_positions_offsets'],
