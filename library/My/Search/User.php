...
class User extends SearchAbstract {
    ...
    public function createIndex() {
        ...
        $mapping->setProperties([
            ...
            'social_profile_url' => ['type' => 'string', 'index' => 'not_analyzed'],
            ...
            'user_fullname' => ['type' => 'string', 'store' => 'yes', 'index_analyzer' => 'translation_index_analyzer', 'search_analyzer' => 'translation_search_analyzer', 'term_vector' => 'with_positions_offsets'],
